...
$STD sudo -u postgres psql -c "CREATE ROLE $DB_USER WITH LOGIN PASSWORD '123456';"
$STD sudo -u postgres psql -c "CREATE DATABASE $DB_NAME WITH OWNER $DB_USER TEMPLATE template0;"
{
  echo "Netbox-Credentials"
  echo -e "Netbox Database User: \e[32m$DB_USER\e[0m"
  echo -e "Netbox Database Password: \e[32m123456\e[0m"
...
sed -i "/DATABASE = {/,/}/s/'PASSWORD': '[^']*'/'PASSWORD': '123456'/" /opt/netbox/netbox/netbox/configuration.py
